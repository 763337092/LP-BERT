...
from data_fn import text2tokens, tokens2bert_ids, LoadDataset, LinkPredictionPairDataset
...
from loss_fn import FocalBCEWithLogitsLoss, FocalBCELoss
...
# PRETRAINED_MODEL_PATH = f'{ROOT_PRETRAINED_PATH}/bert-base-uncased/'
# PRETRAINED_MODEL_PATH = f'{ROOT_PRETRAINED_PATH}/bert-base-chinese/'
PRETRAINED_MODEL_PATH2 = f'{DATA_PATH}/{DATASET}/umls_pretrain/'
CACHE_PATH = f'{DATA_PATH}/{DATASET}/umls_finetune/'
